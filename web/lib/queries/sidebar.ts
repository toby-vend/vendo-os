...
export const DEFAULT_SIDEBAR_CONFIG: SidebarConfig = [
  ...
  },
  {
    id: 'agents',
    label: 'Agents',
    icon: '<svg class="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="9"/><path d="M8 12h8M12 8v8"/></svg>',
    items: [
      { id: 'chat-am', label: 'AM', href: '/chat/am', permission: 'chat-am' },
      { id: 'chat-paid-social', label: 'Paid Social', href: '/chat/paid-social', permission: 'chat-paid-social' },
      { id: 'chat-paid-search', label: 'Paid Search', href: '/chat/paid-search', permission: 'chat-paid-search' },
      { id: 'chat-creative', label: 'Creative', href: '/chat/creative', permission: 'chat-creative' },
      { id: 'chat-seo', label: 'SEO', href: '/chat/seo', permission: 'chat-seo' },
    ],
  },
  {
    id: 'operations',
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'admin-growth', label: 'Growth', href: '/admin/growth' },
