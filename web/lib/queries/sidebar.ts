...
export interface SidebarItem {
  ...
  label: string;
  href: string;
  permission?: string;       // canSee() slug — omit for always-visible
  hidden?: boolean;
}
...
export interface SidebarGroup {
  id: string;
  label: string;
  icon?: string;             // SVG string (only for single-item groups or top-level)
  permission?: string;       // group-level permission gate
  adminOnly?: boolean;
  items: SidebarItem[];
}
...
export const DEFAULT_SIDEBAR_CONFIG: SidebarConfig = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'checklist', label: 'Morning Checklist', href: '/checklist', permission: 'clients' },
  ...
  },
  {
    ...
    items: [
      { id: 'monitors', label: 'Monitors', href: '/operations', permission: 'operations' },
      { id: 'nps', label: 'NPS', href: '/nps', permission: 'operations' },
      { id: 'escalations', label: 'Escalations', href: '/escalations', permission: 'operations' },
    ],
  },
  {
    id: 'admin',
