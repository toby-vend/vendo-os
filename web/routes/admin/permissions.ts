...
export const ROUTE_SLUGS = [
  ...
  { slug: 'chat', label: 'Chat — Atlas (default)' },
  { slug: 'chat-am', label: 'Chat — AM' },
  { slug: 'chat-paid-social', label: 'Chat — Paid Social' },
  { slug: 'chat-paid-search', label: 'Chat — Paid Search' },
  { slug: 'chat-creative', label: 'Chat — Creative' },
  { slug: 'chat-seo', label: 'Chat — SEO' },
